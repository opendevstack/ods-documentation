...
Both two playbooks _site-workspace.yml_ and _site-workspace-full.yml_ are configured to write the outout
in the local directory _docs_local_, wich is ignored by git. This directory is only for local
